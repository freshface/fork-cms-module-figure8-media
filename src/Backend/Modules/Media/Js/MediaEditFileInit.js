...
jsBackend.media.edit_file =
{
	...
	init: function()
	{
	    ...
	    $('.js-launch-feather-editor').click(function(e){
	    	featherEditor.launch({image: $(this).data('id'), url: $(this).data('image')});
	    	return false;
	    });

	    $('.js-reset-file').click(function(e){
			...
			$.ajax(
			{
				data:
				{
					fork: { action: 'ResetModifiedImage' },
					id: jsBackend.data.get('media.id'),
				},
				success: function(json, textStatus)
				{
...
$(jsBackend.media.edit_file.init);
